                          ...
                          # tabPanel("General Metrics", br(),
								  ...
								  mainPanel( 
									 tabsetPanel(id="tabs1",
									    ...
									    tabPanel("Map", br(),
										   hidden(div(id="MapButtonCases", style="display:inline-block; margin-top: 5px;", actionButton(inputId = "mapProcessId", label =  shiny::HTML("<span style='font-size: 90%;'>Process Map Model</span>"), width= 105, style='padding:4px; font-size:80%')) ), br(), br(),
